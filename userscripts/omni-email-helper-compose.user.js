...
// @downloadURL  https://raw.githubusercontent.com/Livingculture/freight-tool/main/userscripts/omni-email-helper-compose.user.js?v=0.1.42
// @updateURL    https://raw.githubusercontent.com/Livingculture/freight-tool/main/userscripts/omni-email-helper-compose.user.js?v=0.1.42
...
(function () {
  ...
  function applyEmbeddedHelperTheme() {
    ...
    const hideLookupButton = () => {
      Array.from(document.querySelectorAll("button, input[type='button'], input[type='submit']"))
        .filter((control) => /^lookup$/i.test(clean(control.textContent || control.value)))
